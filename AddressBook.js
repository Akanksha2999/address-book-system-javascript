...
try {
    addressBook.setLastName = "Thakur";
} catch (e) {
    console.error(e);
}
try {
    addressBook.setAddress = "Nerul";
} catch (e) {
    console.error(e);
}
try {
    addressBook.setCity = "NaviMumbai";
} catch (e) {
    console.error(e);
}
try {
...
try {
    addressBook.setPhoneNumber = "1029384756";
} catch (e) {
    console.error(e);
}
try {
    addressBook.setEmailId = "mahimathakur";
} catch (e) {
    console.error(e);
}
